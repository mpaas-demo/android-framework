    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.broadcast_receiver:
                LocalBroadcastManager.getInstance(MPFramework.getApplicationContext()).sendBroadcast(new Intent(Constants.ACTION_TEST));
                break;
            case R.id.pipeline:
                ...
                break;
            case R.id.service:
                IDataService dataService = MPFramework.getExternalService(IDataService.class.getName());
